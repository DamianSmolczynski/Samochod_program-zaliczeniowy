...
void komunikaty()                                                                               //Komunikaty przypadkow krancowych
{
	if(bieg==7)
		{
			Sleep(500);		cout<<"!!!!!!!!!!!!!!!!!!!!!!!!!!!!!SILNIK ZOSTA WY¤CZONY!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!";		Sleep(4000);
		}
	if(bieg==10)
		{
			Sleep(500);		cout<<"!!!!!!!!!!!!!!!!!!!!!!!!!!!!!SILNIK WYBUCH!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!";		Sleep(4000);
		}
	if(bieg==6)
		{
			Sleep(500);		cout<<"!!!!!!!!!!!!!!!!!!!!!!!!!!!!!WRZUCILES WSTECZNY. SKRZYNIA SI¨ ROZPADA!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!";	Sleep(4000);
		}
	if(bieg==-5)
		{
			Sleep(500);		cout<<"!!!!!!!!!!!!!!!!!!!!!!!!!!!!!SAMOCHàD ZGAS!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!";	Sleep(4000);
		}
}
...
void menu()                                                                                    //Menu prezentujace sterowanie
{
	cout<<"\n\n\n";
										...
										cout<<	"                             /\n";
										cout<<	"                            W\n";
										cout<<	"         bieg w d¢l------ Q   E -------bieg w g¢r©                         P---wyˆ¥cz silnik\n";
										cout<<	"                            S\n";
										cout<<	"                           /\n";
										cout<<	"                    hamulec\n";
...
{ 
    cout<<"            "<<fixed;		cout<<"PR¨DKO—: "<<setprecision(0)<<predkosc<< "   "<< "BIEG: "<<bieg<< "    OBROTY: "<<obroty;
}
...
void odpalanie()                                                                               //Sekwencja odpalania silnika
{
    ...
    {
	cout <<"NACISNIJ 'O' ABY ODPALI SAMOCHàD";      b=getch(); 
    if(b>95)
    {
        b-=32;
    }
